// Add your downloaded IG photos to /public/images/ using these filenames
const photos = [
  { src: '/images/hero-bg.jpg', alt: 'GSF outdoor group bootcamp session' },
  { src: '/images/dymen-bw.jpg', alt: 'Dymen Raimer — Grind Season Fitness' },
  { src: '/images/dymen-stairmaster.jpg', alt: 'Dymen training at LA Fitness' },
  { src: '/images/training-1.jpg', alt: 'Client training session' },
  { src: '/images/training-2.jpg', alt: 'Client deadlift training' },
  { src: '/images/training-3.jpg', alt: 'Client kettlebell training' },
  ...
  { src: '/images/dymen-gsf-tank.jpg', alt: 'Dymen Raimer in GSF branded gear' },
]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
          {photos.map((p, i) => (
            <div
              key={i}
              className={`relative overflow-hidden rounded-lg bg-gsf-dark group ${
                i === 0 ? 'col-span-2 md:col-span-2 row-span-1' : ''
              }`}
            >
              <div className={`${i === 0 ? 'aspect-[16/9]' : 'aspect-[3/4]'} bg-gsf-dark`}>
                <img
                  src={p.src}
                  alt={p.alt}
